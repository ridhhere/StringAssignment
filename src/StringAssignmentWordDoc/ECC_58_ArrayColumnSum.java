...
public class ECC_58_ArrayColumnSum {
	...
	static int[] getColumnSum(int[][] input) {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Row sums: " + Arrays.toString(getColumnSum(array)));
	    System.out.println("Row sums: " + Arrays.toString(getColumnSum(array1)));
	    System.out.println("Row sums null: " + Arrays.toString(getColumnSum(array2)));
